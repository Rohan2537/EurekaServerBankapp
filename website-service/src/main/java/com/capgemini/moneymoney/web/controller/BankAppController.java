...
import com.capgemini.moneymoney.web.entity.CurrentDataSet;
import com.capgemini.moneymoney.web.entity.Transaction;
...
public class BankAppController {
	...
	/*
	 * @RequestMapping("/") public ModelAndView home() { String responseOne =
	 * restTemplate.getForObject("http://hello-service/hello", String.class); return
	 * new ModelAndView("hello","message",responseOne); }
	 */
	...
	public String fund(@RequestParam("senderAccountNumber") int senderAccountNumber,
		...
		restTemplate.postForEntity("http://transaction-service/transactions/transfer?receiverAccountnumber=" + receiverAccountnumber,transaction, null);
		model.addAttribute("message", "Success!!!");
		return "FundTransfer";
	}
	...
	public ModelAndView getStatementDeposit(@RequestParam("offset") int offset, @RequestParam("size") int size) {
		CurrentDataSet currentDataSet = restTemplate.getForObject("http://transaction-service/transactions/statement",
