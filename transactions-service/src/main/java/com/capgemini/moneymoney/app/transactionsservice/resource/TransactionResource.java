package com.capgemini.moneymoney.app.transactionsservice.resource;
...
import com.capgemini.moneymoney.app.transactionsservice.service.TransactionService;
...
public class TransactionResource {
	...
	public ResponseEntity<Transaction> fundTransfer(@RequestBody Transaction senderTansaction,
		...
		ResponseEntity<Double> senderEntity = restTemplate.getForEntity(
				"http://account-service/accounts/" + senderTansaction.getAccountNumber() + "/balance", Double.class);
		...
		restTemplate.put("http://account-service/accounts/" + senderTansaction.getAccountNumber() + "?currentBalance="
				+ updatedBalance[0], null);
		restTemplate.put("http://account-service/accounts/" + receiverTransaction.getAccountNumber() + "?currentBalance="
